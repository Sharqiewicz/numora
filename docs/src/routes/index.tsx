  ...
  head: () => ({
    ...
    scripts: [
      { type: 'application/ld+json', children: JSON.stringify([
        { "@context": "https://schema.org", "@type": "SoftwareApplication", "name": "numora", "applicationCategory": "DeveloperApplication", "operatingSystem": "Web", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD" }, "url": "https://numeric-input.com", "downloadUrl": "https://www.npmjs.com/package/numora", "description": "Precision-first numeric input library for financial and DeFi apps. Zero dependencies, 6.4kb gzipped. Works with React, Vue, Svelte, Angular, SolidJS, and Vanilla JS - and animates with Torph in every framework.", "author": { "@type": "Person", "name": "Kacper Szarkiewicz", "url": "https://x.com/sharqiewicz" }, "codeRepository": "https://github.com/sharqiewicz/numora", "keywords": "numeric input, number input, javascript number input, react number input, vue numeric input, svelte numeric input, angular numeric input, solid numeric input" },
