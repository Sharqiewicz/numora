  ...
  return (
    <div
      className={cn(
        ...
        isBroken ? 'border-red-500/50 bg-red-950/20' : 'border-green-500/50 bg-green-950/20'
      )}
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className={cn('font-medium text-sm', isBroken ? 'text-red-400' : 'text-green-400')}>
          {label}
        </span>
      </div>
      {children}
