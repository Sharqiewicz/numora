...
export const CopyButton = ({
	...
	const resetFallbackTimeoutRef = useRef<
		ReturnType<typeof setTimeout> | undefined
	>(undefined);

	useEffect(() => {
		return () => {
			if (resetFallbackTimeoutRef.current)
				clearTimeout(resetFallbackTimeoutRef.current);
		};
	}, []);
	...
	const accessibleLabel = triggerAnimation
		? "Copied to clipboard"
		: "Copy to clipboard";
